...
COLOR_MAP = {'كشك': '#2980b9', 'غرفة': '#c0392b', 'معلق': '#f1c40f', 'هوائي': '#8e44ad'}
...
with tab_home:
    ...
    if not df_trans.empty:
        ...
        # توتال المحولات (أكشاك، غرف، معلقات)
...
with tab_all_trans:
    if not df_trans.empty:
        ...
        # فلتر القطاعات
        all_sectors = sorted([s for s in df_trans['القطاع'].unique() if s != "غير محدد" and str(s) != 'nan'])
